...
/**
 * A Meat class which own its name, price, availableQuantity, orderDate and expireDate.
 */
public class Meat extends Perishable{
   ...
   */
  public Meat(String name, Double price, Integer availableQuantity, Integer orderDate,
