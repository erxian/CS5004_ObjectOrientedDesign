...
public class Vehicle {
  ...
  /**
   * • * Constructor for an object Vehicle, based on the provided input arguments. • * @param make -
   * String, make of a vehicle • * @param model - String, make of a vehicle • * @param year -
   * Integer, year of the vehicle (expected to be in the range 1950-2020) • * @param vehicleColor -
   * Color, color of a vehicle
   */
